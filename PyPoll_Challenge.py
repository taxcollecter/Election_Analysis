...
file_to_save = 'C:\\Users\\lawof\\Desktop\\Bootcamp\\3\\election_analysis\\analysis\\election_results.txt'
    ...
    for  county_name in county_votes:
        ...
        # 6c: Calculate the percentage of votes for the county.
         ...
         # 6f: Write an if statement to determine the winning county and get its vote count.
            if (cty_votes > winning_county_count) and (cty_vote_percentage > county_winning_percentage):
                winning_county_count = cty_votes
                winning_county = county_name
                county_winning_percentage = cty_vote_percentage
